...
export default function Footer() {
    ...
    // ✅ Navbar Links
    const menuItems = [
        { name: "HOME", path: "/custom-web-development-mumbai" },
        { name: "What We Build ", path: "#what-we-build" },
        { name: "Stack", path: "#Tech_Stack" },
        { name: "FAQ", path: "#FAQ" },
    ];
            ...
            <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <p className="text-sm leading-7 pt-5 text-white/80">
                        NNC is a leading custom web development company in Mumbai offering tailored, scalable and high-performance web solutions for businesses.
                    </p>
